...
```
    ...
    ## # A tibble: 51 × 5
    ##    city_state      prop estimate conf.low conf.high
    ##    <chr>          <dbl>    <dbl>    <dbl>     <dbl>
    ##  1 Albuquerque,NM 0.386    0.386    0.337     0.438
    ##  2 Atlanta,GA     0.383    0.383    0.353     0.415
    ##  3 Baltimore,MD   0.646    0.646    0.628     0.663
    ##  4 Baton Rouge,LA 0.462    0.462    0.414     0.511
    ##  5 Birmingham,AL  0.434    0.434    0.399     0.469
    ##  6 Boston,MA      0.505    0.505    0.465     0.545
    ##  7 Buffalo,NY     0.612    0.612    0.569     0.654
    ##  8 Charlotte,NC   0.300    0.300    0.266     0.336
    ##  9 Chicago,IL     0.736    0.736    0.724     0.747
    ## 10 Cincinnati,OH  0.445    0.445    0.408     0.483
    ## # ℹ 41 more rows
